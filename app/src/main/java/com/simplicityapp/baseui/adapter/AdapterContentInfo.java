...
public class AdapterContentInfo extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterContentInfo(Context context, RecyclerView view, List<ContentInfo> items) {
        this.items = items;
        ctx = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_content_info, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            UITools.Companion.displayImageThumb(ctx , vItem.image, Constant.getURLimgNews(o.getImage()), 0.5f);
